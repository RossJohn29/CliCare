  ...
  static async generateNavigationSteps(department) {
    try {
      ...
      if (!result.success || !result.steps || result.steps.length === 0) {
        throw new Error('No steps found for department');
      }
      ...
      return [
        ...
        { location: 'Vital Signs Station', description: 'Ground Floor - Basic health measurements' },
        { location: `${department} Department`, description: 'Assigned Floor - Wait for your queue number' },
