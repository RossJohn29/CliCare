...
const WebAppointment = () => {
      ...
      try {
        ...
        if (qrResponse.ok) {
          ...
          setRegistrationResult({
            ...
            recommendedDepartment: qrResult.recommended_department,
            type: 'health_assessment'
          });
  ...
  const handleSuccessModalClose = () => {
    ...
    setTimeout(() => {
      window.location.href = '/webapp-patient-dashboard';
    }, 500);
  };
  ...
  const renderPatientInfoStep = () => (
    <div className="webapp-reg-card webapp-step-transition">
      <div className="webapp-step-header">
        <div className="webapp-step-icon"><i className="fa-regular fa-user"></i></div>
        <h3>Patient Information</h3>
        <p>Your Registered Information</p>
      </div>

      <div className="webapp-info-banner">
        <div className="webapp-info-icon"><i className="fa-solid fa-square-check"></i></div>
      ...
      {(!patientData.emergency_contact_name || !patientData.emergency_contact_relationship || !patientData.emergency_contact_no) && (
        <div className="webapp-warning-note">
          <div className="webapp-warning-icon"><i className="fa-solid fa-triangle-exclamation"></i></div>
    ...
    <div className="webapp-reg-card webapp-step-transition">
      ...
      <div className="webapp-symptoms-info">
        <div className={`webapp-info-banner ${showValidation && fieldErrors.selectedSymptoms ? 'has-error' : ''}`}>
          <div className="webapp-info-icon"><i className="fa-solid fa-stethoscope"></i></div>
          <div className="webapp-info-content">
  ...
  const renderDetailsStep = () => {
    ...
    return (
      <div className="webapp-reg-card webapp-step-transition">
        ...
        {hasRoutineOnly && (
          <div className="webapp-info-banner">
            <div className="webapp-info-icon"><i className="fa-solid fa-calendar-check"></i></div>
            <div className="webapp-info-content">
  ...
  const renderSummaryStep = () => (
    <div className="webapp-reg-card webapp-step-transition">
      ...
      <div className="webapp-summary-sections">
        ...
        <div className="webapp-summary-section">
          <h4><i className="fa-regular fa-calendar"></i> Appointment Schedule</h4>
          <div className="webapp-summary-grid">
            <div className="webapp-summary-item">
              <label>Preferred Date:</label>
  ...
  const renderBackButton = () => {
    if (currentStep === 1) {
      return (
        <button
          type="button"
          onClick={() => window.location.href = '/webapp-patient-dashboard'}
          className="webapp-nav-btn home"
        >
          <i className="fa-solid fa-less-than"></i>Back to Dashboard
        </button>
      );
    }
    ...
    return (
      <div className="webapp-popup-overlay">
        <div className="webapp-popup webapp-success-modal">
          <div className="webapp-popup-header">
          </div>
          <div className="webapp-popup-content">
            <div className="webapp-success-content">
              ...
              <div className="webapp-success-message">
                <h4>Health Assessment Completed!</h4>
                <div className="webapp-success-details">
                  <div className="webapp-success-item">
                    <label>Your Temporary ID:</label>
                    <span className="webapp-temp-id">{registrationResult.tempPatientId}</span>
                  </div>
                  <div className="webapp-success-item">
                    <label>Recommended Department:</label>
                    <span className="webapp-department">{registrationResult.recommendedDepartment}</span>
                  </div>
                </div>
                <div className="webapp-qr-info">
                  <p>A QR code has been sent to your email. Present this QR code when you arrive at the hospital for faster check-in.</p>
                </div>
              </div>
              <button
  ...
  return (
    <div className="webapp-registration-portal">
      <div className="webapp-reg-header">
        <div className="webapp-reg-logo">
          <i className="fa-solid fa-hospital"></i>
        </div>
        <div className="webapp-reg-title">
          <h1>CliCare</h1>
