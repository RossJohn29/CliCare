...
const WebLogin = () => {
  ...
  const validatePhoneNumber = (phone) => {
    // Philippine weblogin number format
  ...
  const handleSendOTP = async () => {
    ...
    if (!contactValue.trim()) {
      ...
      if (loginMethod === 'phone' && !validatePhoneNumber(contactValue)) {
        stepErrors.phoneNumber = 'Please enter a valid Philippine weblogin number (09XXXXXXXXX)';
      }
    }
    ...
    <div className="weblogin-card">
      ...
      <div className="weblogin-login-form">
        ...
        >
          {loading ? (
            <>
              <span className="weblogin-loading-spinner"></span>
              Signing In...
            </>
          ) : (
            'Sign In'
