...
const MobileHealthAssessment = () => {
  ...
  const validateStep = (step) => {
    switch (step) {
      ...
      case 2:
        return formData.chiefComplaint && formData.duration && formData.severity;
      case 3:
      ...
      <div className="form-grid">
        <div className="input-group">
          ...
          <textarea
            ...
            placeholder="Describe your main concern or primary symptom in detail"
    ...
    <div className="assessment-step">
        ...
        <div className="urgency-options">
          <label className="urgency-option">
            <input
              ...
              onChange={handleInputChange}
            />
            <span className="urgency-label emergency">🔴 Emergency - Need immediate care</span>
          </label>
          <label className="urgency-option">
            <input
              type="radio"
              ...
              onChange={handleInputChange}
            />
            <span className="urgency-label urgent">🟡 Urgent - Within 24 hours</span>
          </label>
          <label className="urgency-option">
            <input
              type="radio"
              ...
              onChange={handleInputChange}
            />
            <span className="urgency-label normal">🟢 Normal - Regular appointment</span>
          </label>
        </div>
      </div>
      ...
      {formData.urgencyLevel === 'emergency' && (
        <div className="emergency-notice">
          <p>⚠️ <strong>If this is a medical emergency, please call 911 or go to the nearest emergency room immediately.</strong></p>
        </div>
      )}
        ...
        <div className="summary-section">
          ...
          <div className="summary-details">
            <div className="summary-item">
              ...
              <span>{formData.chiefComplaint}</span>
            </div>
            <div className="summary-item">
        ...
        <div className="summary-section">
          ...
          <div className="summary-details">
            <div className="summary-item">
              ...
              <span className={`urgency-level ${formData.urgencyLevel}`}>
                {formData.urgencyLevel === 'emergency' ? '🔴 Emergency' :
