...
const KioskRegistration = () => {
  ...
  const renderPatientInfoStep = () => (
    <div className="kioskreg-card kioskreg-step-transition">
      <div className="kioskreg-step-header">
        <div className="kioskreg-step-icon"><i className="fa-regular fa-user"></i></div>
        <h3>Patient Information</h3>
        <p>Your Registered Information</p>
      </div>

      <div className="kioskreg-info-banner">
        <div className="kioskreg-info-icon"><i className="fa-solid fa-square-check"></i></div>
      ...
      {(!patientData.emergency_contact_name || !patientData.emergency_contact_relationship || !patientData.emergency_contact_no) && (
        <div className="kioskreg-warning-note">
          <div className="kioskreg-warning-icon"><i className="fa-solid fa-triangle-exclamation"></i></div>
        ...
        <div className="kioskreg-id-scan">
          ...
          >
            {!isCameraAvailable() ? 'Camera Not Available (HTTPS Required)' :
              ocrProcessing ? (<><span className="kioskreg-loading-spinner"></span>Scanning ID...</>) : "Scan ID"}
          </button>
        </div>
      </div>
  ...
  const renderEmergencyContactStep = () => (
    <div className="kioskreg-card kioskreg-step-transition">
      <div className="kioskreg-step-header">
        <div className="kioskreg-step-icon"><i className="fa-regular fa-bell"></i></div>
        <h3>Emergency Contact</h3>
        <p>Provide emergency contact information</p>
      </div>

      <div className="kioskreg-emergency-banner">
        <div className="kioskreg-banner-icon"><i className="fa-solid fa-bell"></i></div>
  ...
  const renderReviewStep = () => (
    <div className="kioskreg-card kioskreg-step-transition">
      <div className="kioskreg-step-header">
        <div className="kioskreg-step-icon"><i className="fa-regular fa-clipboard"></i></div>
  ...
  const renderSymptomsStep = () => {
    ...
    return (
      <div className="kioskreg-card kioskreg-step-transition">
        <div className="kioskreg-step-header">
          <div className="kioskreg-step-icon"><i className="fa-solid fa-stethoscope"></i></div>
        ...
        <div className="kioskreg-symptoms-info">
          <div className={`kioskreg-info-banner ${showValidation && fieldErrors.selectedSymptoms ? 'has-error' : ''}`}>
            <div className="kioskreg-info-icon"><i className="fa-solid fa-stethoscope"></i></div>
            <div className="kioskreg-info-content">
  ...
  const renderDetailsStep = () => {
    ...
    return (
      <div className="kioskreg-card kioskreg-step-transition">
        <div className="kioskreg-step-header">
          <div className="kioskreg-step-icon"><i className="fa-solid fa-list-ul"></i></div>
        ...
        {hasRoutineOnly && (
          <div className="kioskreg-info-banner">
            <div className="kioskreg-info-icon"><i className="fa-solid fa-calendar-check"></i></div>
            <div className="kioskreg-info-content">
                  ...
                  {cameraError.includes('HTTPS') ? (
                    ...
                    <>
                      ...
                      <button onClick={() => closeCameraModal(true)} className="kiosk-cancel-btn">
                        <i className="fa-solid fa-pen-to-square"></i> Enter Manually
                      </button>
                    </>
                  )}
                </div>
              ...
              <div className="kiosk-qr-error">
                ...
                <div className="kiosk-error-actions">
                  <button onClick={() => {
                    ...
                    <i className="fa-solid fa-rotate-right"></i> Scan Different QR
                  </button>
                  <button onClick={closeQrScanModal} className="kiosk-cancel-btn">
                    <i className="fa-solid fa-xmark"></i> Cancel
                  </button>
                ...
                <div className="kiosk-manual-actions">
                  {!isScanning && cameraStream && (
                    <button onClick={() => {
                      ...
                      <i className="fa-solid fa-play"></i> Start Scanning
                    </button>
                  )}
                  <button onClick={closeQrScanModal} className="kiosk-cancel-btn">
                    <i className="fa-solid fa-xmark"></i> Cancel
            ...
            <div className="kiosk-success-content">
              ...
              <div className="kiosk-print-options">
                <div className="kiosk-print-status">
                  <i className="fa-solid fa-printer"></i>
                ...
                <div className="kiosk-print-buttons">
                  ...
                  >
                    <i className="fa-solid fa-print"></i> Print Guidance Packet
                  </button>
                  ...
                  >
                    <i className="fa-solid fa-receipt"></i> Print Receipt Only
                  </button>
                </div>
              </div>
  ...
  // Optional: Add a print preview function
const showPrintPreview = (registrationResult) => {
  const currentData = patientType === 'returning' ? patientData : formData;
    ...
    <div class="print-preview-overlay">
      <div class="print-preview-content">
        <div class="print-preview-header">
          <h3>Print Preview - Patient Guidance Packet</h3>
          <button class="close-preview">×</button>
        </div>
        <div class="print-preview-body">
          <iframe id="print-preview-frame" style="width: 100%; height: 500px; border: 1px solid #ddd;"></iframe>
        </div>
        <div class="print-preview-actions">
          <button class="confirm-print">Print Now</button>
  ...
  const printContent = PrintingService.generatePatientGuidancePacket(
    registrationResult, 
    patientType === 'returning' ? patientData : null,
    patientType === 'new' ? formData : null
  );
  ...
  previewModal.querySelector('.close-preview').onclick = () => {
    document.body.removeChild(previewModal);
  };
  
  previewModal.querySelector('.cancel-print').onclick = () => {
    document.body.removeChild(previewModal);
  };
  
  previewModal.querySelector('.confirm-print').onclick = () => {
    handleAutomaticPrint(registrationResult);
    document.body.removeChild(previewModal);
  };
};
      ...
      <div className={`kiosk-toast kiosk-toast-${toastType}`}>
        <div className="kiosk-toast-content">
          <div className="kiosk-toast-icon">
            ...
            {toastType === 'error' && <i className="fa-solid fa-circle-exclamation"></i>}
            {toastType === 'info' && <i className="fa-solid fa-circle-info"></i>}
          </div>
